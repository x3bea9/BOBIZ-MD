...
module.exports = {
    ...
    FOOTER: process.env.FOOTER === undefined ? '𝐋𝐨𝐧𝐳 𝐁𝐎𝐓 🖤-MD  http://Wa.me/+966565652079  تابعني على الواتساب ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '🔱 𝐋𝐨𝐧𝐳 𝐁𝐎𝐓 🖤 🔱 𝙱𝙾𝚃 𝙼𝙳 http://Wa.me/+966565652079 😀' : process.env.CAPTION,
    ...
    STIC_WM:process.env.STIC_WM === undefined ? '𝐋𝐨𝐧𝐳 𝐁𝐎𝐓 🖤' : process.env.STIC_WM,
};
